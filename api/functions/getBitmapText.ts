...
const getBitmapText = (text: string, color: string, size: number, maxWidth: number, maxLines: number, horizontalAlignment: TextStyleAlign): BitmapText => {
